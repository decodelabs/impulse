...
class Impulse implements Proxy
{
    ...
    public static function on(?string $type = NULL, ?callable $listener = NULL, ?string $context = NULL, ?string $action = NULL, Ref3 $priority = DecodeLabs\Impulse\Priority::Medium): Ref0 {
        return static::$instance->on(...func_get_args());
    }
    public static function once(?string $type = NULL, ?callable $listener = NULL, ?string $context = NULL, ?string $action = NULL, Ref3 $priority = DecodeLabs\Impulse\Priority::Medium): Ref0 {
        return static::$instance->once(...func_get_args());
    }
    public static function createSubscription(?string $type = NULL, ?callable $listener = NULL, ?string $context = NULL, ?string $action = NULL, Ref3 $priority = DecodeLabs\Impulse\Priority::Medium, bool $singleUse = false): Ref0 {
